...
export class LogsService {
  ...
  public async emitLogs(pipelineName: string, phaseName: string, appName: string, podName: string, container: string) {
  ...
  public async startLogging(pipelineName: string, phaseName: string, appName: string) {
    const contextName = await this.pipelinesService.getContext(pipelineName, phaseName);
    const namespace = pipelineName+'-'+phaseName;
